...
namespace Paroxe.PdfRenderer.Internal.Viewer
{
    public class PDFSearchPanel : UIBehaviour
    {
        ...
        [SerializeField]
        private TMP_Text m_TotalResultText;
        [SerializeField]
        ...
        public void OnMatchWholeWordClicked()
        {
        ...
        void Update()
        {
            ...
            //if (m_InputField.isFocused && Input.GetKey(KeyCode.Return)) OnNextButton();

            if (m_AnimationPosition >= 1.0f) return;
            ...
            switch (m_Opened)
            {
                case true:
                {
                    ...
                    if (Math.Abs(m_AnimationPosition - 1.0f) < 0.0f)
                    {
                ...
                case false:
                {
                    ...
                    if (Math.Abs(m_AnimationPosition - 1.0f) < 0.0f)
                    {
                        m_TotalResultText.text = /*"0 of 0"*/ "0 Found";
                    }
        ...
        private void UpdateSearchTotal()
        {
            if (m_Total > 0)
            {
                ...
                m_TotalResultText.text = m_Total + " Found";
            }
            else
            {
                m_TotalResultText.text = /*"0 of 0"*/ "0 Found";
